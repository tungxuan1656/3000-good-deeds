...
*   **Logic:**
    *   Random từ database theo 3 nhóm: Thân (body) / Khẩu (speech) / Ý (mind).
    *   Mỗi gợi ý gồm: `category`, `name`, `detail`, `note`.
    *   User có thể bỏ qua (Next) hoặc chọn làm theo nếu phù hợp.
