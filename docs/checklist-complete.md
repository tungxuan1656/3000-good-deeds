...
- [ ] Quy ước thuật ngữ thống nhất:
	- [ ] “Việc thiện” / “Gieo duyên” / “Tu tập” / “Quán chiếu” / “Sổ tay quán chiếu”
...
- [ ] Sửa/Xoá: dialog xác nhận dùng ái ngữ, không dọa nạt.
...
- [ ] Mô tả rõ nguyên tắc “Write & Let Go” (không sửa/xoá sau khi lưu — nếu vẫn giữ).
- [ ] Copy an toàn: “Ứng dụng không thay thế chuyên gia” (tùy bạn quyết).

#### J) Profile / Settings
- [ ] Copy quyền riêng tư: xuất dữ liệu, xoá tài khoản, tắt thông báo.
- [ ] “Xoá tài khoản”: mô tả rõ dữ liệu bị xoá, thời gian hiệu lực.
...
- [ ] Màn 4: Quyền dữ liệu: xem/xuất/xoá tài khoản (dễ rời đi).
...
- [ ] Màn 3: Nguyên tắc lưu trữ (không sửa/xoá? có xoá? chốt 1 hướng).
