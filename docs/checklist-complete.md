...
- [x] Copy nút đăng nhập: rõ ràng (Google), có link “Điều khoản sử dụng” và “Chính sách riêng tư”.
...
- [x] Tour guide “Chào mừng” auto mở ở Login; tắt auto ở Home.
- [x] Tour guide “Ghi nhận việc thiện” auto mở ở Home (check-in).
...
- [x] Chuẩn hoá format file nguồn (CSV/JSON) + versioning.
	- [x] CSV quotes: [backend/resources/kinhphapcu-all.csv](../backend/resources/kinhphapcu-all.csv)
	- [x] CSV random-acts: [backend/resources/random-acts-all.csv](../backend/resources/random-acts-all.csv)
...
- [x] Có cơ chế “Báo lỗi nội dung” (sai nguồn, khó hiểu, không phù hợp).
...
- [x] 1 trang “Điều khoản sử dụng”.
- [x] 1 trang “Privacy & Data”: dữ liệu nào lưu, lưu ở đâu, cách xoá, cách xuất.
