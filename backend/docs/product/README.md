...
- `reminders-spec.md`: backend reminder and push-subscription behavior.
- `cultivation-spec.md`: wisdom quotes and random acts behavior.
- `journal-spec.md`: backend journal behavior and retention rules.
