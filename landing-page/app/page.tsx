            ...
            <div className="grid gap-16 md:grid-cols-2 md:items-center">
              <div>
                ...
                <div className="mt-6 space-y-6 text-lg leading-relaxed text-muted-foreground">
                  ...
                  <p>
                    Theo triết lý phương Đông và nguồn cảm hứng từ cuốn sách <strong>Liễu Phàm Tứ Huấn</strong>, vận mệnh con người hoàn toàn có thể thay đổi bằng cách tích lũy đủ 3000 việc thiện. Đây không phải là một áp lực, mà là một hành trình dài để cải biến tâm tính.
                  </p>
                  <p>
